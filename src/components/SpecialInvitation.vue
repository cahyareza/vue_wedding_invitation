<template>
    <section class="hero is-small">
        <div class="hero-body">
            ...
            <!-- <p class="is-size-6-tablet is-size-7-mobile mt-2">H. Akil Somantri, B.A</p>
            <p class="is-size-6-tablet is-size-7-mobile mb-1">Bpk. Agus</p> 
            <p class="is-size-6-tablet is-size-7-mobile mb-1">Bpk. Ronie, S.Ap </p>
            <p class="is-size-6-tablet is-size-7-mobile mb-1">Bpk. Ronie, S.Ap </p>   
            <p class="is-size-6-tablet is-size-7-mobile mb-1">Bpk. Ronie, S.Ap </p>   
            <p class="is-size-6-tablet is-size-7-mobile mb-1">Bpk. Ronie, S.Ap </p>         -->
        </div>
