                ...
                <div class="hero-body is-paddingless">
                    <div class="section py-5 is-marginless">
                        <div class="container">
                            ...
                            <div v-else>
                                <div class="column is-half is-offset-one-quarter is-three-fifths-mobile is-offset-one-fifth-mobile my-0-mobile py-0-mobile">
                                    <hr class="is-paddingless is-marginless has-background-grey-light" style="background-color: #666;">
                                    <hr class="is-paddingless has-background-grey-light" style="background-color: #666; margin-top: 1px">
                                </div>
