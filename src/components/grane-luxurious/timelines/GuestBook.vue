<template>
    <p class="subtitle-4">{{ jumlahHadir }} tamu merespon akan datang,</p>
    <button @click="showhidebutton" class="button-2 is-rounded mt-4 mb-4">
    ...
    <form v-if="show" class="form" v-on:submit.prevent>
        ...
        <div class="field has-text-left">
            <p class="subtitle-4">konfirmasi kehadiran:</p>
                <label class="radio">
                    <p class="subtitle-4"><input type="radio" name="rsvp" value="iya" v-model="konfirmasi.hadir">
                    Iya, saya akan datang</p>
                </label>
                <br/>
                <label class="radio">
                    <p class="subtitle-4"><input type="radio" name="rsvp" value="tidak" v-model="konfirmasi.hadir">
                    Maaf, sepertinya tidak bisa</p>
                </label>
        </div>  
        <button @click="confirmHadir" class="button button-3 is-size-6">Kirim</button>
    </form>
</template>
